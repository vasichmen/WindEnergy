...
namespace WindEnergy.Lib.Geomodel
{
    /// <summary>
    ...
    class SphereCalculations
    {
        ...
        public static double CalculateAngle(PointLatLng A, PointLatLng B, PointLatLng C)
        {
            ...
            double lat1 = A.Lat * rad1deg; //α1
            double lat2 = C.Lat * rad1deg; //α2
            double lon1 = A.Lng * rad1deg; //β1
            double lon2 = C.Lng * rad1deg; //β2
            double NPlat = B.Lat * rad1deg; //широта северного полюса
            double NPlon = B.Lng * rad1deg; //долгота северного полюса
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static double CalculateDistance(PointLatLng c1, PointLatLng c2)
        {
        ...
        /// <returns></returns>
        public static PointLatLng SphereDirect(PointLatLng start, double azimuth, double length, double radius)
        {
 ...
 */
            ...
            double[] pt1 = { start.Lat * in1grad, start.Lng * in1grad }; //исходная точка
            ...
            return new PointLatLng(pt[0] / in1grad, pt[1] / in1grad); //вывод результата с переводом в градусы
 ...
 *     x - вектор {x, y, z}
 */
        private static void SpherToCart(double[] y, double[] x)
        {
            double p;
 ...
 */
        private static void Rotate(double[] x, double a, int i)
        {
            double c, s, xj;
            int j, k;
 ...
 *     длину вектора
 */
        private static double CartToSpher(double[] x, double[] y)
        {
            double p;

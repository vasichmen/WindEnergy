...
namespace WindEnergy.UI.Dialogs
{
    ...
    {
        private Dictionary<Months, double> Values;
        ...
        private Dictionary<Months, Label> Labels = new Dictionary<Months, Label>();
        private Dictionary<Months, TextBox> Textboxes = new Dictionary<Months, TextBox>();
